...
bot = telebot.TeleBot('7567349538:AAFiDnxsoC1NV1HAJtHIpbR8L-ar6qS7F0Q')
...
def create_random_key(length=10):
    ...
    custom_key = f"GAURAV-VIP-{random_key.upper()}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𑁍┊GAURAV 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)
